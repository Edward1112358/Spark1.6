...
/**
  * spark-submit --master yarn-client --num-executors 3 --executor-memory 512m --executor-cores 2 --class com.dt.spark.WordCountCopy /home/aisinobi/src/Spark.jar
  */

object WordCountCopy {
  def main(args: Array[String]): Unit = {
    //Spark程序运行时的配置信息
    ///val conf = new SparkConf()
    ///conf.setAppName("My First Spark")
    ///conf.setMaster("local")
    val conf = new SparkConf().setAppName("Spark Pi").setMaster("spark://192.168.24.201:7077")
